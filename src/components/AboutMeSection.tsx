        ...
        <section id='about' className='py-12 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white relative overflow-hidden'>
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 relative z-10">
                <div className='flex flex-col gap-4 text-center lg:text-left'>
                    ...
                    <p className='text-chocolate/70 max-w-prose text-base sm:text-lg leading-relaxed'>
                        My philosophy is simple: write clean code, solve real problems, and never stop learning. Currently specializing in <span className="text-primary font-medium">React, JavaScript, TypeScript, Node.js and cloud integrations</span> with expertise in AI integration, design systems, and cross-platform development.
                    </p>
                </div>
            </div>
        </section>
